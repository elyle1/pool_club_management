...
def updateStaffMember(inputs):
  recordInput = inputs
  sql = "UPDATE staff SET firstname = %s, lastname = %s, hiredate = %s, separationdate = %s, reasonforseparation = %s, password = %s, usertype = %s WHERE id_num = %s"
  val = (recordInput[1], recordInput[2], recordInput[3], recordInput[4], recordInput[5], recordInput[6], recordInput[7], recordInput[0])
  mycursor.execute(sql, val)
  mydb.commit()
